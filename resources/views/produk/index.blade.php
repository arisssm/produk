...
@section('content')
    <div class="row">
        ...
        <div class="card-header ms-3">
            ...
            <h4 class="fw-bold text-secondary d-inline">List Data Produk</h4>
        </div>
        <div class="col-lg-12 mb-5">
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <div class="pb-3" style="text-align: end">
                    <a href='{{ url('produk/create') }}' class="btn btn-sm btn-primary">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md">Harga</th>
                            <th class="col-md">Status</th>
                            <th class="col-md">Stok</th>
